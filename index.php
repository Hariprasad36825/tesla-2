...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
	  ...
	  <div class="item">
        <img src="static/img/img4.jpg" alt="Los Angeles" width="1200" height="700">    
      </div>
	  
	  <div class="item">
        <img src="static/img/img5.jpg" alt="Los Angeles" width="1200" height="700">    
      </div>
	  
	  <div class="item">
        <img src="static/img/img6.jpg" alt="Los Angeles" width="1200" height="700">    
      </div>
	  
	  <div class="item">
        <img src="static/img/img7.jpg" alt="Los Angeles" width="1200" height="700">    
      </div>
    </div>
